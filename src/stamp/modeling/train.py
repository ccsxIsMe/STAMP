    ...
    *,
    ...
    if (
        ...
        raise ValueError(
            ...
            "For single-target classification set model_name to 'vit', 'trans_mil', 'trans_mil_fusion', 'dsmil', 'dtfd_mil', or 'mlp'."
        )
...
def setup_model_from_dataloaders(
    *,
    train_dl: DataLoader,
    valid_dl: DataLoader,
    target_train_dl: DataLoader | None,
    task: Task,
    ...
    common_params = {
        ...
        "domain_hidden_dim": advanced.domain_hidden_dim,
        "domain_dropout": advanced.domain_dropout,
        "use_pseudolabels": advanced.use_pseudolabels,
        "pseudolabel_loss_weight": advanced.pseudolabel_loss_weight,
        "pseudolabel_warmup_epochs": advanced.pseudolabel_warmup_epochs,
        "use_distillation": advanced.use_distillation,
        "distillation_loss_weight": advanced.distillation_loss_weight,
        "distillation_warmup_epochs": advanced.distillation_warmup_epochs,
        "distillation_temperature": advanced.distillation_temperature,
