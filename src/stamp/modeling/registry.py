...
def load_model_class(task: Task, feature_type: str, model_name: ModelName):
    ...
    match model_name:
        ...
        case ModelName.ABMIL_DOMAIN:
            from stamp.modeling.models.abmil_domain import (
                ABMILDomain as ModelClass,
            )
        ...
        case ModelName.DTFD_MIL:
            from stamp.modeling.models.dtfd_mil import DTFDMIL as ModelClass
