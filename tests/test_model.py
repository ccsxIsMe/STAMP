...
from stamp.modeling.models.dtfd_mil import DTFDMIL
...
from stamp.modeling.models.trans_mil_fusion import TransMILFusion
...
def test_trans_mil_with_feature_adapter_dims(
    num_classes: int = 2,
    batch_size: int = 4,
    n_tiles: int = 81,
    input_dim: int = 512,
    ...
    model = TransMIL(
        ...
        feature_adapter_hidden_dim=384,
...
def test_trans_mil_with_feature_adapter_inference_reproducibility(
    num_classes: int = 2,
    batch_size: int = 3,
    n_tiles: int = 64,
    input_dim: int = 384,
...
def test_trans_mil_fusion_dims(
    num_classes: int = 2,
    batch_size: int = 4,
    n_tiles: int = 81,
    input_dim: int = 512,
...
def test_trans_mil_fusion_inference_reproducibility(
    num_classes: int = 2,
    batch_size: int = 3,
    n_tiles: int = 64,
    input_dim: int = 384,
...
def test_dtfd_mil_inference_reproducibility(
    num_classes: int = 2,
    batch_size: int = 3,
    n_tiles: int = 64,
    input_dim: int = 384,
